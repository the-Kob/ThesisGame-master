...
events_csv$OBSERVED_QUADRANT <- which.pmax(events_csv$observed_pref_BUFF_PLAYER, events_csv$observed_pref_NERF_PLAYER, events_csv$observed_pref_BUFF_COMPANION, events_csv$observed_pref_NERF_COMPANION)

events_csv$OBSERVED_QUADRANT[events_csv$OBSERVED_QUADRANT == 1] <- "Self Challenger"
events_csv$OBSERVED_QUADRANT[events_csv$OBSERVED_QUADRANT == 2] <- "Self Facilitator"
events_csv$OBSERVED_QUADRANT[events_csv$OBSERVED_QUADRANT == 3] <- "Others' Challenger"
events_csv$OBSERVED_QUADRANT[events_csv$OBSERVED_QUADRANT == 4] <- "Other's Facilitator"
...
events_csv$IMI_INTEREST_ENJOYMENT_SCORE <- (events_csv$X.I.enjoyed.doing.this.activity.very.much.. +
                        events_csv$X.This.activity.was.fun.to.do.. + (8 - events_csv$X.I.thought.this.was.a.boring.activity..) +
                        (8-events_csv$X.This.activity.did.not.hold.my.attention.at.all..) +
...
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Nerf.your.enemies."] <- "CompSC_PERCEIVED_FREQ_NERF_PLAYER_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Nerf.your.enemies..1"] <- "CompSF_PERCEIVED_FREQ_NERF_PLAYER_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Nerf.your.enemies..2"] <- "CompOC_PERCEIVED_FREQ_NERF_PLAYER_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Nerf.your.enemies..3"] <- "CompOF_PERCEIVED_FREQ_NERF_PLAYER_ENEMY"

colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Buff.your.enemies."] <- "CompSC_PERCEIVED_FREQ_BUFF_PLAYER_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Buff.your.enemies..1"] <- "CompSF_PERCEIVED_FREQ_BUFF_PLAYER_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Buff.your.enemies..2"] <- "CompOC_PERCEIVED_FREQ_BUFF_PLAYER_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Buff.your.enemies..3"] <- "CompOF_PERCEIVED_FREQ_BUFF_PLAYER_ENEMY"

colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Buff.his.enemies."] <- "CompSC_PERCEIVED_FREQ_BUFF_COMPANION_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Buff.his.enemies..1"] <- "CompSF_PERCEIVED_FREQ_BUFF_COMPANION_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Buff.his.enemies..2"] <- "CompOC_PERCEIVED_FREQ_BUFF_COMPANION_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Buff.his.enemies..3"] <- "CompOF_PERCEIVED_FREQ_BUFF_COMPANION_ENEMY"

colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Nerf.his.enemies."] <- "CompSC_PERCEIVED_FREQ_NERF_COMPANION_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Nerf.his.enemies..1"] <- "CompSF_PERCEIVED_FREQ_NERF_COMPANION_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Nerf.his.enemies..2"] <- "CompOC_PERCEIVED_FREQ_NERF_COMPANION_ENEMY"
colnames(events_csv)[colnames(events_csv) == "Regarding.frequence..how.much.did.your.companion.use.the.following.effects...Nerf.his.enemies..3"] <- "CompOF_PERCEIVED_FREQ_NERF_COMPANION_ENEMY"

colnames(events_csv)[colnames(events_csv) == "X.I.rate.my.experience.playing.side.by.side.with.this.companions.as."] <- "CompSC_EXPERIENCE_RATE"
colnames(events_csv)[colnames(events_csv) == "X.I.rate.my.experience.playing.side.by.side.with.this.companions.as..1"] <- "CompSF_EXPERIENCE_RATE"
colnames(events_csv)[colnames(events_csv) == "X.I.rate.my.experience.playing.side.by.side.with.this.companions.as..2"] <- "CompOC_EXPERIENCE_RATE"
colnames(events_csv)[colnames(events_csv) == "X.I.rate.my.experience.playing.side.by.side.with.this.companions.as..3"] <- "CompOF_EXPERIENCE_RATE"

colnames(events_csv)[colnames(events_csv) == "Regading.utility..rate.the.following.effects.throughout.the.experiment..Buff.my.enemies."] <- "BUFF_PLAYER_ENEMY_PERCEIVED_UTILITY"
colnames(events_csv)[colnames(events_csv) == "Regading.utility..rate.the.following.effects.throughout.the.experiment..Nerf.my.enemies."] <- "NERF_PLAYER_ENEMY_PERCEIVED_UTILITY"
colnames(events_csv)[colnames(events_csv) == "Regading.utility..rate.the.following.effects.throughout.the.experiment..Buff.my.companion.s.enemies."] <- "BUFF_COMPANION_ENEMY_PERCEIVED_UTILITY"
colnames(events_csv)[colnames(events_csv) == "Regading.utility..rate.the.following.effects.throughout.the.experiment..Nerf.my.companion.s.enemies."] <- "NERF_COMPANION_ENEMY_PERCEIVED_UTILITY"

colnames(events_csv)[colnames(events_csv) == "Identify.each.companion.regarding.their.interaction.model.s.quadrant...A."] <- "CompSC_PERCEIVED_QUADRANT"
colnames(events_csv)[colnames(events_csv) == "Identify.each.companion.regarding.their.interaction.model.s.quadrant...B."] <- "CompSF_PERCEIVED_QUADRANT"
colnames(events_csv)[colnames(events_csv) == "Identify.each.companion.regarding.their.interaction.model.s.quadrant...C."] <- "CompOC_PERCEIVED_QUADRANT"
colnames(events_csv)[colnames(events_csv) == "Identify.each.companion.regarding.their.interaction.model.s.quadrant...D."] <- "CompOF_PERCEIVED_QUADRANT"



write.csv(events_csv, 'Events_processed_final.csv', row.names = FALSE)