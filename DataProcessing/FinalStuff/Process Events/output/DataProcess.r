...
resultsLog <- resultsLog %>%
    mutate(COMPANION_ACCURACY_CompOC = CompOC_HIT_COMPANION_COMPANION_ENEMY / (CompOC_HIT_COMPANION_COMPANION_ENEMY + CompOC_MISS_COMPANION_COMPANION_ENEMY))

resultsLog <- resultsLog %>%
    mutate(COMPANION_ACCURACY_CompOF = CompOF_HIT_COMPANION_COMPANION_ENEMY / (CompOF_HIT_COMPANION_COMPANION_ENEMY + CompOF_MISS_COMPANION_COMPANION_ENEMY))

resultsLog <- resultsLog %>%
    mutate(COMPANION_ACCURACY_CompSC = CompSC_HIT_COMPANION_COMPANION_ENEMY / (CompSC_HIT_COMPANION_COMPANION_ENEMY + CompSC_MISS_COMPANION_COMPANION_ENEMY))

resultsLog <- resultsLog %>%
    mutate(COMPANION_ACCURACY_CompSF = CompSF_HIT_COMPANION_COMPANION_ENEMY / (CompSF_HIT_COMPANION_COMPANION_ENEMY + CompSF_MISS_COMPANION_COMPANION_ENEMY))
...
resultsLog[is.na(resultsLog)] <- 0

write.csv(resultsLog, 'Events_processed.csv', row.names = FALSE)